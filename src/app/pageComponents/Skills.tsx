...
useGSAP(() => {
    gsap.from(".skill", {
      ...
      duration: 0.8,
      ease: "power3.out",
      stagger: 0.2, // 👈 delay each card by 0.2s
      scrollTrigger: {
        trigger: ".skills-wrapper", // 👈 parent trigger
        start: "top 80%",
    ...
    <section className="main-container-wrapper" id="skills">
      <div className="py-10 main-container overflow-hidden">
        <div className="w-full relative z-1">
          ...
          <div ref={skillsRef} className="skill-container grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {skills.map((skill, index) => {
              const Icon = skill.icon;
              return (
                <div
                  key={index}
                  className="skillitem group relative bg-card rounded-xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
                >
