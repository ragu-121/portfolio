    ...
    return (
        <section className='custom-container w-full pt-16 px-6 pb-6 flex flex-col items-center justify-center gap-6 lg:flex-row'>
            ...
            <div className='w-full'>
                ...
                <input type="text" name="name" id="Name" className="w-full h-11 rounded-lg border outline-0 px-3 hover:border-primary focus:border-primary focus:shadow-[0_0_0_0.25rem_#afef9e]" onChange={handleChange} value={datas.name} autoComplete='off' />
                ...
                <input type="email" name="email" id="email" className="w-full h-11 rounded-lg border outline-0 px-3 hover:border-primary focus:border-primary focus:shadow-[0_0_0_0.25rem_#afef9e]" value={datas.email} onChange={handleChange} autoComplete='off' />
                ...
                <textarea rows={6} name="message" id="message" className="w-full rounded-lg border outline-0 p-3 resize-none hover:border-primary focus:border-primary focus:shadow-[0_0_0_0.25rem_#afef9e]" value={datas.message} onChange={handleChange}></textarea>

                <div className="w-full pt-3">
                    <button className="px-4 py-2 text-base bg-secondary cursor-pointer" onClick={hanldeClear}>Clear All</button>
                    <button className="px-4 py-2 text-base bg-primary ml-2 cursor-pointer" onClick={handleSubmit}>Submit</button>
                </div>
            </div>
            {
